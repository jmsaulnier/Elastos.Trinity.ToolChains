(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-level4-level4-module"],{

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/level4/level4.page.html":
/*!*************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/pages/level4/level4.page.html ***!
  \*************************************************************************************/
...
/*!***********************************************!*\
  !*** ./src/app/pages/level4/level4.module.ts ***!
  \***********************************************/
/*! exports provided: Level4PageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Level4PageModule", function() { return Level4PageModule; });
...
/* harmony import */ var _level4_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./level4.page */ "./src/app/pages/level4/level4.page.ts");
...
var routes = [
    {
        path: '',
        component: _level4_page__WEBPACK_IMPORTED_MODULE_5__["Level4Page"]
    }
];
var Level4PageModule = /** @class */ (function () {
    function Level4PageModule() {
    }
    Level4PageModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_level4_page__WEBPACK_IMPORTED_MODULE_5__["Level4Page"]]
        })
    ], Level4PageModule);
    return Level4PageModule;
}());
...
/***/ "./src/app/pages/level4/level4.page.scss":
/*!***********************************************!*\
  !*** ./src/app/pages/level4/level4.page.scss ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("h2 {\n  font-weight: 800; }\n\nimg {\n  width: 80px;\n  height: 80px;\n  border: solid 2px #000;\n  border-radius: 12px; }\n\n/*# sourceMappingURL=data:application/json;base64, */");

/***/ }),

/***/ "./src/app/pages/level4/level4.page.ts":
/*!*********************************************!*\
  !*** ./src/app/pages/level4/level4.page.ts ***!
  \*********************************************/
/*! exports provided: Level4Page */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Level4Page", function() { return Level4Page; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var Level4Page = /** @class */ (function () {
    function Level4Page(gameService) {
        this.gameService = gameService;
        this.cardsTotal = 20; // Total cards to match (divided by 2)
        this.cardsArray = []; // Store all card pairs
        this.userLife = 7; // Total amount of tries user gets
    ...
    Level4Page.prototype.ngOnInit = function () {
        this.restartGame();
    };
    Level4Page.prototype.ionViewWillEnter = function () {
        titleBarManager.setTitle('Level 4');
    };
    // Function to populate cards array with
    // position and value pairs from 0 to 6
    Level4Page.prototype.populateCards = function () {
        this.cardsArray = [];
        var x = 0;
        var y = 0;
    ...
    Level4Page.prototype.selectCard = function (pos, val, i) {
        var _this = this;
        var actOne = false;
    ...
    Level4Page.prototype.shuffle = function (a) {
        var j, x, i;
        for (i = a.length; i; i--) {
    ...
    Level4Page.prototype.restartGame = function () {
        var _this = this;
    ...
    // Win condition
    Level4Page.prototype.winCon = function () {
        var winCheck = false;
    ...
    // Lose condition
    Level4Page.prototype.loseCon = function () {
        this.gameState = 'lose';
    };
    // Function to reset selected cards
    Level4Page.prototype.resetSelects = function () {
        this.selectCard1pos = -1; // Selected card #1 position
        this.selectCard1val = -1; // Selected card #1 value
        this.selectCard2pos = -1; // Selected card #2 position
        this.selectCard2val = -1; // Selected card #2 value
    };
    Level4Page.ctorParameters = function () { return [
        { type: src_app_services_game_service__WEBPACK_IMPORTED_MODULE_1__["GameService"] }
    ]; };
    Level4Page = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-level4',
            template: __importDefault(__webpack_require__(/*! raw-loader!./level4.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/level4/level4.page.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./level4.page.scss */ "./src/app/pages/level4/level4.page.scss")).default]
        }),
...
//# sourceMappingURL=pages-level4-level4-module.js.map